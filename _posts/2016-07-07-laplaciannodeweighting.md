...
ページランクは，グラフのノードに重みをつけるアルゴリズムです．
...
なぜなのか，をいろいろ考えましたが，ページランクはノードの重みを繰り返し伝搬するので，初期値が大事というより，エッジが大事なんだと今は思っています（もう少しちゃんと考える必要あり）．
